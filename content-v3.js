...
(function() {
  ...
  __modules['utils'] = (function() {
    ...
    const log = {
      ...
      debug: (...args) => {
        ...
        return { isContextValid, safeStorageGet, safeStorageSet, safeSendMessage, waitForElement, waitForVisible, waitForRemoval, isElementVisible, isInViewport, getElementText, getInteractiveElements, getToggles, clickElement, setToggleState, getToggleState, hash, structureHash, debounce, throttle, setDebugMode, initLogging, log };
  ...
  __modules['actor'] = (function() {
    ...
    const { clickElement, setToggleState, getToggleState, waitForElement, waitForRemoval, waitForVisible, isElementVisible, getToggles, log } = __modules['utils'];
